...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        for(unsigned int i = 0; i < 10; i++)
        {
            ...
            // camera postion 
                /*
                    Bản chất trong openGL không có camera hay có thể nói camera trong openGL ở 000 và nhìn xuông 00-1 
                    Nếu chúng ta muốn làm hiệu ứng camera di chuyển chúng ta không thể làm điều đó tuy nhiên chúng ta có thể tạo ra hiệu ứng đó 
                    bằng cách di chuyển các vật theo chiều hướng ngược lại so với camera 
                */
            view  = glm::translate(view, glm::vec3(3.0f, -3.0f, -3.0f));  
                // => tạo hiệu ứng camera di chuyển lên trên theo trục Oz và Oy và di chuyển theo chiều âm theo trục Oz 
                // => ảnh sẽ dịch theo chiều ngược lại tức là theo chiều âm của Oz, Oy và theo chiều dương của Ox 
