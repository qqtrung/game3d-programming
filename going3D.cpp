...
int main()
{
    ...
    //     -1.0f, -1.0f, 0.0f,     1.0f, 1.0f, 0.0f,   0.0f, 2.0f
    // };
    ...
    // có radians -> chiều cao với khoảng cách là 1 ở tham số thứ 3 từ đó suy ra luôn được chiều rộng nhờ tỉ lệ 
    // sau đó ánh xạ điểm ảnh lên vị trí đó 
    glm::mat4 projection = glm::perspective(glm::radians(90.0f), (float)SCR_WIDTH / SCR_HEIGHT, 1.0f, 2.0f);
